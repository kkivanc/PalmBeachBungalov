    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        navLinks.forEach(link => {
            link.addEventListener("click", function () {
                let bsCollapse = new bootstrap.Collapse(navbar, { toggle: true });
            });
        });
    });
...
$(document).ready(function () {
    ...
    $("#toggle-gallery").html(showMoreText);

    $("#toggle-gallery").click(function (event) {
        event.preventDefault(); // Prevent default link behavior
    
        var $gallery = $(".gallery-hidden");
    
        if ($gallery.is(":visible")) {
            // Close images and change button text
            ...
            // Open images and change button text
